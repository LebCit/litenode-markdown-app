 ...
 *
 * This function selects all anchor elements within the main navigation menu, checks
 ...
 * @function
 */
export const highlightCurrentMenuItem = () => {
	// Select all anchor elements within the main navigation menu
	const anchors = document.querySelectorAll("main-menu-nav a")
