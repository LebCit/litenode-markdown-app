...
export const openCloseMobileMenu = () => {
	...
	const mainMenuSidebar = document.querySelector("main-menu-sidebar")
	...
	const mobileMenuCloser = document.querySelector("main-menu-header").lastElementChild
	...
	mobileMenuTrigger.firstElementChild.addEventListener("click", () => {
		...
		mainMenuSidebar.style.width = "100%"
